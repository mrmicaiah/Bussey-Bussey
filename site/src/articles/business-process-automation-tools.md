...
summary: "Everyone wants a business process automation tool. Most of the ones being sold to you aren't needed anymore. Here's what's actually happening to the category."
tags:
  - article
...
That distinction — between a tool that records and a tool that works — is the same one that separates a chatbot that frustrates your customers from an agent that actually helps them. (We wrote about exactly that line in [how to automate customer service without driving customers away](/articles/automate-customer-service/).)
