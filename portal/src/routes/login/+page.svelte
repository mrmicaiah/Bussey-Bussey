<script lang="ts">
  ...
  async function onSubmit(e: Event) {
    ...
    submitting = true;
    try {
      await api.post('/api/portal/auth/login', { email, password });
...
<svelte:head><title>Sign in · Bussey Client Portal</title></svelte:head>

<main>
  <div class="card surface">
    <h1>Bussey · Client Portal</h1>
    <p class="muted small">
      Sign in with the credentials your Bussey contact shared with you.
    </p>
